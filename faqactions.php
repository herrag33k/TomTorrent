...
elseif ($_GET[action] == "edit" && isset($_GET[id])) {
 ...
 while ($arr = mysql_fetch_array($res, MYSQL_BOTH)) {
  ...
  if ($arr[type] == "item") {
   ...
   print("<tr><td>Question:</td><td><input style=\"width: 500px;\" type=\"text\" name=\"question\" value=\"$arr[question]\" /></td></tr>\n");
   print("<tr><td style=\"vertical-align: top;\">Answer:</td><td><textarea style=\"width: 500px; height=300px;\" name=\"answer\">$arr[answer]</textarea></td></tr>\n");
