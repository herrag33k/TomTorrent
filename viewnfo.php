...
stdhead();
print("<h1>NFO fyrir <a href=details.php?id=$id>".htmlentities($a["name"])."</a></h1>\n");
...
<tr>
  ...
  title="Teckensnittshack: Använder någon av teckensnitten MS LineDraw eller Terminal"><b>Teckensnittshack</b></a></td>*/?>
  <td align="center" width="50%">
    <a href="viewnfo.php?id=<?=$id?>&view=magic" 
      title="Breytt fyrir NFO">
      <b>DOS</b></a></td>
  <td align="center" width="50%">
    <a href="viewnfo.php?id=<?=$id?>&view=latin-1"
      title="Venjulegt"><b>Windows</b></a></td>
  <?/*<td align="center" width="25%">
