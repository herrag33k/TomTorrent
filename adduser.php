...
if ($HTTP_SERVER_VARS["REQUEST_METHOD"] == "POST")
{
  ...
  $secret = sqlesc($secret);
	$md5s = md5(mksecret());
	mysql_query("INSERT INTO users (added, last_access, secret, username, passhash, status, email, md5secret) VALUES(NOW(), NOW(), $secret, $username, $passhash, 'confirmed', $email, '$md5s')") or sqlerr(__FILE__, __LINE__);
