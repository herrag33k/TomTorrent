<div align=center>
  ...
  <form name="form1" method="post" action="browse.php">
<textarea name="skilmalar" cols="80" rows="18" readonly="readonly" wrap="virtual" id="skilmalar"><? include("disclaimer.php"); ?></textarea>      
<br>
<br><table width=400><tr><td>Sá sem fyrir tilviljun, mistök eða án 
sérstakrar heimildar tekur við símskeytum, myndum eða öðrum fjarskiptamerkjum og táknum eða hlustar á símtöl má ekki skrá neitt slíkt hjá sér eða notfæra sér það á nokkurn hátt. Jafnframt ber honum að tilkynna sendanda að upplýsingar hafi ranglega borist sér. Skylt er að gæta fyllsta trúnaðar í slíkum tilfellum.</td></tr></table>
