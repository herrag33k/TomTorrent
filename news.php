...
if ($action == 'edit')
{
  ...
  else
  {
	  ...
	  print("<tr><td style='padding: 0px'><textarea name=body cols=100 rows=5 style='border: 0px'>" . htmlspecialchars($arr["body"]) . "</textarea></td></tr>\n");
...
print("<table border=1 cellspacing=0 cellpadding=5>\n");
print("<tr><td style='padding: 10px'><textarea name=body cols=100 rows=5 style='border: 0px'></textarea>\n");
